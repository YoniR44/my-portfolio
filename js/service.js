...
function createProject(id, name, title, desc, publishedAt, imgUrl, type) {
    return {
        id: id,
        name: name,
        title: title,
...
function createProjects() {
    ...
    'Jan 24th, 2019', 'img/portfolio/01-full.jpg', 'Game'));
    ...
    'January 17th, 2019', 'img/portfolio/05-full.jpg', 'Game'));
    ...
    'February 3rd, 2019', 'img/portfolio/06-full.jpg', 'Database'));
}
